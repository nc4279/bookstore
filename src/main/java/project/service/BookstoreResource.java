...
import project.model.DTO.BookWithoutLoginDTO;
...
public class BookstoreResource {
    ...
    public Response getAllBooksFromMistic() {
        ...
        List<BookWithoutLoginDTO> newBooks = books.stream().map(book -> modelMapper.map(book, BookWithoutLoginDTO.class)).collect(Collectors.toList());
